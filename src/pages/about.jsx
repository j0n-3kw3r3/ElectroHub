  ...
  return (
    <div>
      ...
      <div className=" space-y-10 pb-16">
        {/* Who We Are Section */}
        <div className="flex flex-col md:flex-row items-center px-[5%] py-10  bg-gray-100 ">
        ...
        <div className="flex flex-col md:flex-row items-center bg-gray-100 px-[5%] py-10 ">
          <div className="md:w-1/2 p-16">
