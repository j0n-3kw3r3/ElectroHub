...
export default function Hero({ data }) {
  ...
  return (
    <div className="bg-gray-200 pb-10 md:pb-0 dark:text-default-200 text-default-800  shadow w-full  ">
      <div className="mx-[6%] md:mr-0 md:ml-[14%] relative z-0 items-center md:flex gap-6 ">
        <div className=" md:w-[50%] w-[70%] md:mx-0 pt-20  z-100  ">
          ...
          <button
            className="bg-primary rounded text-white px-4 py-2 flex items-center gap-2 shadow-lg hover:scale-105 ease-in-out duration-150 text-sm  "
            onClick={() => {
