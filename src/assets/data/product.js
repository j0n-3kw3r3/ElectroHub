...
export const products = [
  {
    ...
    new: true,
    reviews: [
      { id: 1, name: "John", comment: "Great product!", rating: 4.5 },
      { id: 2, name: "Jane", comment: "Works perfectly!", rating: 5 },
    ],
    inStock: true,
    category: ["Microcontrollers", "passive"],
    quantity: 10,
  },
  {
    id: 2,
    ...
    new: false,
    reviews: [
      { id: 1, name: "Mike", comment: "Excellent device!", rating: 4.8 },
      { id: 2, name: "Sarah", comment: "Highly recommended!", rating: 4.5 },
    ],
    inStock: true,
    category: ["Single-board Computers", "Electronics"],
    quantity: 5,
  },
  {
    id: 3,
    ...
    new: true,
    reviews: [
      { id: 1, name: "David", comment: "Great value for money!", rating: 4.2 },
      { id: 2, name: "Emily", comment: "Easy to use!", rating: 4.7 },
    ],
    inStock: false,
    category: ["Integrated Circuits", "Timers"],
    quantity: 0,
  },
  {
    id: 4,
    ...
    new: true,
    reviews: [
      { id: 1, name: "Alex", comment: "Very accurate readings!", rating: 4.5 },
      { id: 2, name: "Olivia", comment: "Compact and portable!", rating: 4.3 },
    ],
    inStock: true,
    category: ["Test and Measurement", "Multimeters"],
    quantity: 3,
  },
  {
    id: 5,
    ...
    new: false,
    reviews: [
      { id: 1, name: "Sophia", comment: "Great quality!", rating: 4.6 },
      { id: 2, name: "James", comment: "Very reliable!", rating: 4.4 },
    ],
    inStock: false,
    category: ["Power Supplies", "Bench Power Supplies"],
    quantity: 0,
  },
  {
    id: 6,
    ...
    new: true,
    reviews: [
      { id: 1, name: "Daniel", comment: "Great value for money!", rating: 4.2 },
      { id: 2, name: "Emma", comment: "Easy to use!", rating: 4.7 },
    ],
    inStock: true,
    category: ["Integrated Circuits", "Timers"],
    quantity: 8,
  },
  {
    ...
    new: true,
    reviews: [
      { id: 1, name: "Liam", comment: "Very accurate readings!", rating: 4.5 },
      { id: 2, name: "Ava", comment: "Compact and portable!", rating: 4.3 },
    ],
    inStock: true,
    category: ["Test and Measurement", "Multimeters"],
    quantity: 2,
